    ...
    constructor() {
        ...
        this.findAll = (req, res) => {
            ...
            Tutorial.findAll(condition)
                ...
                .catch((err) => { res.status(500).send({ message: err.message || 'Retrieve all tutorials failure.' }); });
        };
        // Retrieve tutorial by id 
        this.findOne = (req, res) => {
            const id = req.params.id;
            Tutorial.findByPk(id).then((data) => { res.send(data); })
        ...
        this.update = (req, res) => {
            ...
            Tutorial.update(req.body, condition)
                ...
                .catch((err) => { res.status(500).send({ message: err.message || 'Update tutorial failure. (id: ' + id + ')' }); });
        };
        ...
        this.delete = (req, res) => {
            ...
            Tutorial.destroy(condition)
                ...
                .catch((err) => { res.status(500).send({ message: err.message || 'Delete tutorial failure. (id: ' + id + ')' }); });
        };
    }
}
